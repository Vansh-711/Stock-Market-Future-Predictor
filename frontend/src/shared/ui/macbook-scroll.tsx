...
export const MacbookScroll = ({
  ...
  return (
    ...
    >
      ...
      >
        {title}
        <p className="mt-4 text-text-muted text-body-medium animate-pulse">
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <div className="relative z-10 w-full h-full bg-canvas rounded-lg overflow-y-auto [&::-webkit-scrollbar]:hidden p-4">
