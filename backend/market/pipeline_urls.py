...
urlpatterns = [
    ...
    path("jobs/latest/", pipeline_views.latest_job, name="pipeline-job-latest"),
    ...
    path("jobs/live/trigger/", pipeline_views.trigger_live_ingest, name="pipeline-job-live-trigger"),
]
